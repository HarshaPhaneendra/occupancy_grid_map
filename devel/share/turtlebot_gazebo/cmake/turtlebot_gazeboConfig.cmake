...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_gazebo_SOURCE_PREFIX /home/hp/ogm_generation/src/turtlebot_simulator/turtlebot_gazebo)
  set(turtlebot_gazebo_DEVEL_PREFIX /home/hp/ogm_generation/devel)
  ...
  set(turtlebot_gazebo_INSTALL_PREFIX /home/hp/ogm_generation/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hp/ogm_generation/src/turtlebot_simulator/turtlebot_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hp/ogm_generation/devel/lib;/home/hp/Project4_ws/devel/lib;/opt/ros/kinetic/lib)
